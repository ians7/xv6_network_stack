...
forktest(void)
{
  ...
  3e:	47650513          	addi	a0,a0,1142 # 4b0 <recvfrom+0x10>
  ...
  68:	49c50513          	addi	a0,a0,1180 # 500 <recvfrom+0x60>
  ...
  8a:	43a50513          	addi	a0,a0,1082 # 4c0 <recvfrom+0x20>
  ...
  a4:	43850513          	addi	a0,a0,1080 # 4d8 <recvfrom+0x38>
  ...
  e4:	41050513          	addi	a0,a0,1040 # 4f0 <recvfrom+0x50>
...
0000000000000444 <create_thread>:
...
000000000000048c <recv>:
.global recv
recv:
 li a7, SYS_recv
 48c:	02000893          	li	a7,32
 ecall
 490:	00000073          	ecall
 ret
 494:	8082                	ret

0000000000000496 <sendto>:
.global sendto
sendto:
 li a7, SYS_sendto
 496:	02100893          	li	a7,33
 ecall
 49a:	00000073          	ecall
 ret
 49e:	8082                	ret

00000000000004a0 <recvfrom>:
.global recvfrom
recvfrom:
 li a7, SYS_recvfrom
 4a0:	02200893          	li	a7,34
 ecall
 4a4:	00000073          	ecall
 ret
 4a8:	8082                	ret
