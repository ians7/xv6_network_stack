...
forktest(void)
{
  ...
  3c:	44850513          	addi	a0,a0,1096 # 480 <thread_exit+0xc>
  ...
  66:	46e50513          	addi	a0,a0,1134 # 4d0 <thread_exit+0x5c>
  ...
  88:	40c50513          	addi	a0,a0,1036 # 490 <thread_exit+0x1c>
  ...
  a2:	40a50513          	addi	a0,a0,1034 # 4a8 <thread_exit+0x34>
  ...
  e2:	3e250513          	addi	a0,a0,994 # 4c0 <thread_exit+0x4c>
