...
forktest(void)
{
  ...
  3e:	42e50513          	addi	a0,a0,1070 # 468 <thread_exit+0xc>
  ...
  68:	41450513          	addi	a0,a0,1044 # 478 <thread_exit+0x1c>
  ...
  b8:	41450513          	addi	a0,a0,1044 # 4c8 <thread_exit+0x6c>
  ...
  d4:	3c850513          	addi	a0,a0,968 # 498 <thread_exit+0x3c>
  ...
  ee:	3c650513          	addi	a0,a0,966 # 4b0 <thread_exit+0x54>
