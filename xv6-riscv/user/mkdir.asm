...
main(int argc, char *argv[])
{
  ...
  42:	a4258593          	addi	a1,a1,-1470 # a80 <ithread_join+0x4c>
  46:	4509                	li	a0,2
  ...
  60:	a3c58593          	addi	a1,a1,-1476 # a98 <ithread_join+0x64>
  64:	4509                	li	a0,2
...
00000000000003a6 <create_thread>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 406:	71650513          	addi	a0,a0,1814 # b18 <digits>
 40a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c6:	5fec8c93          	addi	s9,s9,1534 # ac0 <ithread_join+0x8c>
 ...
 4d4:	648b8b93          	addi	s7,s7,1608 # b18 <digits>
 ...
 5fa:	4c298993          	addi	s3,s3,1218 # ab8 <ithread_join+0x84>
        while(*s != 0){
 5fe:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6dc:	9387b783          	ld	a5,-1736(a5) # 1010 <freep>
 ...
 704:	00e6ea63          	bltu	a3,a4,718 <free+0x4a>
{
 ...
 746:	8cf73723          	sd	a5,-1842(a4) # 1010 <freep>
}
 74a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 778:	89c53503          	ld	a0,-1892(a0) # 1010 <freep>
 ...
 7a0:	87490913          	addi	s2,s2,-1932 # 1010 <freep>
  if(p == (char*)-1)
 7a4:	5afd                	li	s5,-1
 7a6:	a895                	j	81a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7a8:	00001797          	auipc	a5,0x1
 7ac:	88878793          	addi	a5,a5,-1912 # 1030 <base>
 ...
 7dc:	82a73c23          	sd	a0,-1992(a4) # 1010 <freep>
      return (void*)(p + 1);
...
void ithread_exit(uint64 status) {
 ...
 842:	b78080e7          	jalr	-1160(ra) # 3b6 <thread_exit>
}
 846:	60a2                	ld	ra,8(sp)
 848:	6402                	ld	s0,0(sp)
...
int free_stacks() {
 ...
 860:	7c47a783          	lw	a5,1988(a5) # 1020 <num_threads>
 864:	02f05c63          	blez	a5,89c <free_stacks+0x4e>
 868:	4481                	li	s1,0
    free(stacks[i]);
 86a:	00000997          	auipc	s3,0x0
 86e:	7ae98993          	addi	s3,s3,1966 # 1018 <stacks>
  for (int i = 0; i < num_threads; i++) {
 872:	00000917          	auipc	s2,0x0
 876:	7ae90913          	addi	s2,s2,1966 # 1020 <num_threads>
    free(stacks[i]);
 87a:	0009b783          	ld	a5,0(s3)
 87e:	00349713          	slli	a4,s1,0x3
 882:	97ba                	add	a5,a5,a4
 884:	6388                	ld	a0,0(a5)
 886:	00000097          	auipc	ra,0x0
 88a:	e48080e7          	jalr	-440(ra) # 6ce <free>
  for (int i = 0; i < num_threads; i++) {
 88e:	0485                	addi	s1,s1,1
 890:	00092703          	lw	a4,0(s2)
 894:	0004879b          	sext.w	a5,s1
 898:	fee7c1e3          	blt	a5,a4,87a <free_stacks+0x2c>
  free(stacks);
 89c:	00000497          	auipc	s1,0x0
 8a0:	77c48493          	addi	s1,s1,1916 # 1018 <stacks>
 8a4:	6088                	ld	a0,0(s1)
 8a6:	00000097          	auipc	ra,0x0
 8aa:	e28080e7          	jalr	-472(ra) # 6ce <free>
  stacks = 0;
 8ae:	0004b023          	sd	zero,0(s1)
  num_threads = 0;
 8b2:	00000797          	auipc	a5,0x0
 8b6:	7607a723          	sw	zero,1902(a5) # 1020 <num_threads>
  max_stacks = INIT_MAX_STACKS;
 8ba:	47a1                	li	a5,8
 8bc:	00000717          	auipc	a4,0x0
 8c0:	74f72223          	sw	a5,1860(a4) # 1000 <max_stacks>
  threads_done = 0;
 8c4:	00000797          	auipc	a5,0x0
 8c8:	7607a023          	sw	zero,1888(a5) # 1024 <threads_done>
}
 8cc:	4501                	li	a0,0
 8ce:	70a2                	ld	ra,40(sp)
 8d0:	7402                	ld	s0,32(sp)
 8d2:	64e2                	ld	s1,24(sp)
 8d4:	6942                	ld	s2,16(sp)
 8d6:	69a2                	ld	s3,8(sp)
 8d8:	6145                	addi	sp,sp,48
 8da:	8082                	ret

00000000000008dc <expand_num_threads>:
int expand_num_threads() {
 ...
 8ec:	71878793          	addi	a5,a5,1816 # 1000 <max_stacks>
 8f0:	4388                	lw	a0,0(a5)
 8f2:	0015151b          	slliw	a0,a0,0x1
 8f6:	c388                	sw	a0,0(a5)
  void **new_stacks = malloc(max_stacks*sizeof(char*));
 8f8:	0035151b          	slliw	a0,a0,0x3
 8fc:	00000097          	auipc	ra,0x0
 900:	e54080e7          	jalr	-428(ra) # 750 <malloc>
 904:	892a                	mv	s2,a0
  memmove(new_stacks, stacks, num_threads*sizeof(char*));
 906:	00000617          	auipc	a2,0x0
 90a:	71a62603          	lw	a2,1818(a2) # 1020 <num_threads>
 90e:	00000497          	auipc	s1,0x0
 912:	70a48493          	addi	s1,s1,1802 # 1018 <stacks>
 916:	0036161b          	slliw	a2,a2,0x3
 91a:	608c                	ld	a1,0(s1)
 91c:	00000097          	auipc	ra,0x0
 920:	930080e7          	jalr	-1744(ra) # 24c <memmove>
  free(stacks);
 924:	6088                	ld	a0,0(s1)
 926:	00000097          	auipc	ra,0x0
 92a:	da8080e7          	jalr	-600(ra) # 6ce <free>
  stacks = new_stacks;
 92e:	0124b023          	sd	s2,0(s1)
}
 932:	4501                	li	a0,0
...
0000000000000940 <ithread_create>:

int ithread_create(void* (*fn_ptr)(void *), void *args) {
 940:	7179                	addi	sp,sp,-48
 942:	f406                	sd	ra,40(sp)
 944:	f022                	sd	s0,32(sp)
 946:	ec26                	sd	s1,24(sp)
 ...
 956:	6c67b783          	ld	a5,1734(a5) # 1018 <stacks>
 95a:	c3d1                	beqz	a5,9de <ithread_create+0x9e>
    stacks = malloc(max_stacks*sizeof(char*));
  }
  if (num_threads == max_stacks) {
 95c:	00000797          	auipc	a5,0x0
 960:	6a47a783          	lw	a5,1700(a5) # 1000 <max_stacks>
 964:	00000717          	auipc	a4,0x0
 968:	6bc72703          	lw	a4,1724(a4) # 1020 <num_threads>
 96c:	00f71a63          	bne	a4,a5,980 <ithread_create+0x40>
    if (max_stacks == MAX_THREADS) {
 970:	04000713          	li	a4,64
 974:	08e78463          	beq	a5,a4,9fc <ithread_create+0xbc>
      printf("ERROR: Thread capacity has been reached\n");
      return -1;
    }
    expand_num_threads();
 978:	00000097          	auipc	ra,0x0
 97c:	f64080e7          	jalr	-156(ra) # 8dc <expand_num_threads>
  }

  void *stack_ptr = malloc(PGSIZE);
 980:	6505                	lui	a0,0x1
 982:	00000097          	auipc	ra,0x0
 986:	dce080e7          	jalr	-562(ra) # 750 <malloc>
 98a:	84aa                	mv	s1,a0
  stacks[num_threads] = stack_ptr;
 98c:	00000717          	auipc	a4,0x0
 990:	69472703          	lw	a4,1684(a4) # 1020 <num_threads>
 994:	070e                	slli	a4,a4,0x3
 996:	00000797          	auipc	a5,0x0
 99a:	6827b783          	ld	a5,1666(a5) # 1018 <stacks>
 99e:	97ba                	add	a5,a5,a4
 9a0:	e388                	sd	a0,0(a5)
  int res = create_thread(fn_ptr, args, stack_ptr, &ithread_exit);
 9a2:	00000697          	auipc	a3,0x0
 9a6:	e9468693          	addi	a3,a3,-364 # 836 <ithread_exit>
 9aa:	862a                	mv	a2,a0
 9ac:	85ce                	mv	a1,s3
 9ae:	854a                	mv	a0,s2
 9b0:	00000097          	auipc	ra,0x0
 9b4:	9f6080e7          	jalr	-1546(ra) # 3a6 <create_thread>
 9b8:	892a                	mv	s2,a0
  if (res != -1) {
 9ba:	57fd                	li	a5,-1
 9bc:	04f50a63          	beq	a0,a5,a10 <ithread_create+0xd0>
    num_threads++;
 9c0:	00000717          	auipc	a4,0x0
 9c4:	66070713          	addi	a4,a4,1632 # 1020 <num_threads>
 9c8:	431c                	lw	a5,0(a4)
 ...
 9e2:	62252503          	lw	a0,1570(a0) # 1000 <max_stacks>
 9e6:	0035151b          	slliw	a0,a0,0x3
 9ea:	00000097          	auipc	ra,0x0
 9ee:	d66080e7          	jalr	-666(ra) # 750 <malloc>
 9f2:	00000797          	auipc	a5,0x0
 9f6:	62a7b323          	sd	a0,1574(a5) # 1018 <stacks>
 9fa:	b78d                	j	95c <ithread_create+0x1c>
      printf("ERROR: Thread capacity has been reached\n");
 9fc:	00000517          	auipc	a0,0x0
 a00:	13450513          	addi	a0,a0,308 # b30 <digits+0x18>
 a04:	00000097          	auipc	ra,0x0
 a08:	c94080e7          	jalr	-876(ra) # 698 <printf>
      return -1;
 a0c:	597d                	li	s2,-1
 a0e:	b7c1                	j	9ce <ithread_create+0x8e>
    free(stack_ptr);
 a10:	8526                	mv	a0,s1
 a12:	00000097          	auipc	ra,0x0
 a16:	cbc080e7          	jalr	-836(ra) # 6ce <free>
    stacks[num_threads] = 0;
 a1a:	00000717          	auipc	a4,0x0
 a1e:	60672703          	lw	a4,1542(a4) # 1020 <num_threads>
 a22:	070e                	slli	a4,a4,0x3
 a24:	00000797          	auipc	a5,0x0
 a28:	5f47b783          	ld	a5,1524(a5) # 1018 <stacks>
 a2c:	97ba                	add	a5,a5,a4
 a2e:	0007b023          	sd	zero,0(a5)
 a32:	bf71                	j	9ce <ithread_create+0x8e>

0000000000000a34 <ithread_join>:
...
int ithread_join(int thread_id) {
 ...
 a3c:	fec40593          	addi	a1,s0,-20
 a40:	00000097          	auipc	ra,0x0
 a44:	96e080e7          	jalr	-1682(ra) # 3ae <join_thread>
  threads_done++;
 a48:	00000717          	auipc	a4,0x0
 a4c:	5dc70713          	addi	a4,a4,1500 # 1024 <threads_done>
 a50:	431c                	lw	a5,0(a4)
 a52:	2785                	addiw	a5,a5,1
 a54:	0007869b          	sext.w	a3,a5
 a58:	c31c                	sw	a5,0(a4)
  if (threads_done == num_threads) {
 a5a:	00000797          	auipc	a5,0x0
 a5e:	5c67a783          	lw	a5,1478(a5) # 1020 <num_threads>
 a62:	00d78863          	beq	a5,a3,a72 <ithread_join+0x3e>
    free_stacks();
  }
  return status;
}
 a66:	fec42503          	lw	a0,-20(s0)
 ...
 a76:	ddc080e7          	jalr	-548(ra) # 84e <free_stacks>
 a7a:	b7f5                	j	a66 <ithread_join+0x32>
