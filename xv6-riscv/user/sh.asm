...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	5fe58593          	addi	a1,a1,1534 # 1610 <ithread_join+0x48>
      1a:	8532                	mv	a0,a2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	5b858593          	addi	a1,a1,1464 # 1618 <ithread_join+0x50>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	172080e7          	jalr	370(ra) # 11dc <fprintf>
  exit(1);
      72:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	58650513          	addi	a0,a0,1414 # 1620 <ithread_join+0x58>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	68670713          	addi	a4,a4,1670 # 174c <ithread_join+0x184>
    ...
    panic("runcmd");
      ...
      e6:	54650513          	addi	a0,a0,1350 # 1628 <ithread_join+0x60>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	52c58593          	addi	a1,a1,1324 # 1630 <ithread_join+0x68>
     10c:	4509                	li	a0,2
     10e:	00001097          	auipc	ra,0x1
     112:	0ce080e7          	jalr	206(ra) # 11dc <fprintf>
  exit(0);
     116:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     154:	4f058593          	addi	a1,a1,1264 # 1640 <ithread_join+0x78>
     158:	4509                	li	a0,2
     15a:	00001097          	auipc	ra,0x1
     15e:	082080e7          	jalr	130(ra) # 11dc <fprintf>
      exit(1);
     162:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1ea:	46a50513          	addi	a0,a0,1130 # 1650 <ithread_join+0x88>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28c:	03e080e7          	jalr	62(ra) # 12c6 <malloc>
     290:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d6:	ff4080e7          	jalr	-12(ra) # 12c6 <malloc>
     2da:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     330:	f9a080e7          	jalr	-102(ra) # 12c6 <malloc>
     334:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     336:	4661                	li	a2,24
     338:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     376:	f54080e7          	jalr	-172(ra) # 12c6 <malloc>
     37a:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37c:	4661                	li	a2,24
     37e:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b8:	f12080e7          	jalr	-238(ra) # 12c6 <malloc>
     3bc:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3be:	4641                	li	a2,16
     3c0:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     402:	51a98993          	addi	s3,s3,1306 # 2918 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     468:	4b498993          	addi	s3,s3,1204 # 2918 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4c8:	45498993          	addi	s3,s3,1108 # 2918 <whitespace>
     4cc:	00002a97          	auipc	s5,0x2
     4d0:	444a8a93          	addi	s5,s5,1092 # 2910 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     546:	3d698993          	addi	s3,s3,982 # 2918 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	0c4b0b13          	addi	s6,s6,196 # 1678 <ithread_join+0xb0>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ce:	08e50513          	addi	a0,a0,142 # 1658 <ithread_join+0x90>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6aa:	fda60613          	addi	a2,a2,-38 # 1680 <ithread_join+0xb8>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6ea:	fbab0b13          	addi	s6,s6,-70 # 16a0 <ithread_join+0xd8>
  ...
  return ret;
     ...
     720:	f6c50513          	addi	a0,a0,-148 # 1688 <ithread_join+0xc0>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     77e:	f1650513          	addi	a0,a0,-234 # 1690 <ithread_join+0xc8>
...
00000000000007aa <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ce:	ede60613          	addi	a2,a2,-290 # 16a8 <ithread_join+0xe0>
     7d2:	85a6                	mv	a1,s1
     7d4:	854a                	mv	a0,s2
...
000000000000081e <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     840:	e74a0a13          	addi	s4,s4,-396 # 16b0 <ithread_join+0xe8>
  ...
  if(peek(ps, es, ";")){
     ...
     876:	e4660613          	addi	a2,a2,-442 # 16b8 <ithread_join+0xf0>
     87a:	85ce                	mv	a1,s3
     87c:	854a                	mv	a0,s2
...
00000000000008c6 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8dc:	da860613          	addi	a2,a2,-600 # 1680 <ithread_join+0xb8>
  ...
  if(!peek(ps, es, ")"))
     ...
     90c:	dc860613          	addi	a2,a2,-568 # 16d0 <ithread_join+0x108>
     910:	85ca                	mv	a1,s2
     912:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     94e:	d7650513          	addi	a0,a0,-650 # 16c0 <ithread_join+0xf8>
     952:	fffff097          	auipc	ra,0xfffff
     956:	704080e7          	jalr	1796(ra) # 56 <panic>
    panic("syntax - missing )");
     95a:	00001517          	auipc	a0,0x1
     95e:	d7e50513          	addi	a0,a0,-642 # 16d8 <ithread_join+0x110>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     98a:	dde70713          	addi	a4,a4,-546 # 1764 <ithread_join+0x19c>
...
0000000000000a02 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a3a:	d1260613          	addi	a2,a2,-750 # 1748 <ithread_join+0x180>
     a3e:	85a6                	mv	a1,s1
     a40:	854a                	mv	a0,s2
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a70:	c8458593          	addi	a1,a1,-892 # 16f0 <ithread_join+0x128>
     a74:	4509                	li	a0,2
     a76:	00000097          	auipc	ra,0x0
     a7a:	766080e7          	jalr	1894(ra) # 11dc <fprintf>
    panic("syntax");
     a7e:	00001517          	auipc	a0,0x1
     a82:	c0a50513          	addi	a0,a0,-1014 # 1688 <ithread_join+0xc0>
...
0000000000000a8e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     aa4:	c6090913          	addi	s2,s2,-928 # 1700 <ithread_join+0x138>
     aa8:	85a6                	mv	a1,s1
     aaa:	854a                	mv	a0,s2
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     ac8:	00002497          	auipc	s1,0x2
     acc:	e8848493          	addi	s1,s1,-376 # 2950 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b16:	00002517          	auipc	a0,0x2
     b1a:	e3a50513          	addi	a0,a0,-454 # 2950 <buf.0>
     b1e:	00000097          	auipc	ra,0x0
     b22:	0da080e7          	jalr	218(ra) # bf8 <strlen>
     b26:	fff5079b          	addiw	a5,a0,-1
     b2a:	1782                	slli	a5,a5,0x20
     b2c:	9381                	srli	a5,a5,0x20
     b2e:	00002717          	auipc	a4,0x2
     b32:	e2270713          	addi	a4,a4,-478 # 2950 <buf.0>
     b36:	97ba                	add	a5,a5,a4
     b38:	00078023          	sb	zero,0(a5)
      if(chdir(buf+3) < 0)
     b3c:	00002517          	auipc	a0,0x2
     b40:	e1750513          	addi	a0,a0,-489 # 2953 <buf.0+0x3>
     b44:	00000097          	auipc	ra,0x0
     b48:	362080e7          	jalr	866(ra) # ea6 <chdir>
     b4c:	fa0551e3          	bgez	a0,aee <main+0x60>
        fprintf(2, "cannot cd %s\n", buf+3);
     b50:	00002617          	auipc	a2,0x2
     b54:	e0360613          	addi	a2,a2,-509 # 2953 <buf.0+0x3>
     b58:	00001597          	auipc	a1,0x1
     b5c:	bb058593          	addi	a1,a1,-1104 # 1708 <ithread_join+0x140>
     b60:	4509                	li	a0,2
     b62:	00000097          	auipc	ra,0x0
     b66:	67a080e7          	jalr	1658(ra) # 11dc <fprintf>
     b6a:	b751                	j	aee <main+0x60>
      runcmd(parsecmd(buf));
     b6c:	00002517          	auipc	a0,0x2
     b70:	de450513          	addi	a0,a0,-540 # 2950 <buf.0>
...
0000000000000ede <create_thread>:
...
0000000000000f26 <recv>:
.global recv
recv:
 li a7, SYS_recv
     f26:	02000893          	li	a7,32
 ecall
     f2a:	00000073          	ecall
 ret
     f2e:	8082                	ret

0000000000000f30 <sendto>:
.global sendto
sendto:
 li a7, SYS_sendto
     f30:	02100893          	li	a7,33
 ecall
     f34:	00000073          	ecall
 ret
     f38:	8082                	ret

0000000000000f3a <recvfrom>:
.global recvfrom
recvfrom:
 li a7, SYS_recvfrom
     f3a:	02200893          	li	a7,34
 ecall
     f3e:	00000073          	ecall
 ret
     f42:	8082                	ret
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f5a:	f00080e7          	jalr	-256(ra) # e56 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
     ...
     f6c:	f04a                	sd	s2,32(sp)
     f6e:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     f74:	cad9                	beqz	a3,100a <printint+0xa4>
     f76:	01f5d79b          	srliw	a5,a1,0x1f
     f7a:	cbc1                	beqz	a5,100a <printint+0xa4>
    neg = 1;
    x = -xx;
  ...
  do{
    buf[i++] = digits[x % base];
     f8a:	00001817          	auipc	a6,0x1
     f8e:	84e80813          	addi	a6,a6,-1970 # 17d8 <digits>
     f92:	88ba                	mv	a7,a4
     f94:	0017051b          	addiw	a0,a4,1
     f98:	872a                	mv	a4,a0
     f9a:	02c5f7bb          	remuw	a5,a1,a2
     f9e:	1782                	slli	a5,a5,0x20
     fa0:	9381                	srli	a5,a5,0x20
     fa2:	97c2                	add	a5,a5,a6
     ...
     fb4:	fcc7ffe3          	bgeu	a5,a2,f92 <printint+0x2c>
  if(neg)
     fb8:	00030c63          	beqz	t1,fd0 <printint+0x6a>
    buf[i++] = '-';
     fbc:	fd050793          	addi	a5,a0,-48
     fc0:	00878533          	add	a0,a5,s0
     fc4:	02d00793          	li	a5,45
     fc8:	fef50823          	sb	a5,-16(a0)
     fcc:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
     fd0:	02e05763          	blez	a4,ffe <printint+0x98>
     fd4:	f426                	sd	s1,40(sp)
     fd6:	377d                	addiw	a4,a4,-1
     fd8:	00e984b3          	add	s1,s3,a4
     fdc:	19fd                	addi	s3,s3,-1
     fde:	99ba                	add	s3,s3,a4
     fe0:	1702                	slli	a4,a4,0x20
     fe2:	9301                	srli	a4,a4,0x20
     fe4:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     fe8:	0004c583          	lbu	a1,0(s1)
     fec:	854a                	mv	a0,s2
     fee:	00000097          	auipc	ra,0x0
     ff2:	f56080e7          	jalr	-170(ra) # f44 <putc>
  while(--i >= 0)
     ff6:	14fd                	addi	s1,s1,-1
     ff8:	ff3498e3          	bne	s1,s3,fe8 <printint+0x82>
     ffc:	74a2                	ld	s1,40(sp)
}
     ffe:	70e2                	ld	ra,56(sp)
    1000:	7442                	ld	s0,48(sp)
    1002:	7902                	ld	s2,32(sp)
    1004:	69e2                	ld	s3,24(sp)
    1006:	6121                	addi	sp,sp,64
    1008:	8082                	ret
  neg = 0;
    100a:	4301                	li	t1,0
    100c:	bf9d                	j	f82 <printint+0x1c>

000000000000100e <vprintf>:
}
...
{
    100e:	715d                	addi	sp,sp,-80
    1010:	e486                	sd	ra,72(sp)
    1012:	e0a2                	sd	s0,64(sp)
    1014:	f84a                	sd	s2,48(sp)
    1016:	0880                	addi	s0,sp,80
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    101c:	1a090b63          	beqz	s2,11d2 <vprintf+0x1c4>
    1020:	fc26                	sd	s1,56(sp)
    1022:	f44e                	sd	s3,40(sp)
    1024:	f052                	sd	s4,32(sp)
    1026:	ec56                	sd	s5,24(sp)
    1028:	e85a                	sd	s6,16(sp)
    102a:	e45e                	sd	s7,8(sp)
    102c:	8aaa                	mv	s5,a0
    102e:	8bb2                	mv	s7,a2
  ...
  state = 0;
    ...
    103a:	4b55                	li	s6,21
    103c:	a839                	j	105a <vprintf+0x4c>
        putc(fd, c);
    103e:	85ca                	mv	a1,s2
    1040:	8556                	mv	a0,s5
    1042:	00000097          	auipc	ra,0x0
    1046:	f02080e7          	jalr	-254(ra) # f44 <putc>
    104a:	a019                	j	1050 <vprintf+0x42>
    } else if(state == '%'){
    104c:	01498d63          	beq	s3,s4,1066 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
    1050:	0485                	addi	s1,s1,1
    1052:	fff4c903          	lbu	s2,-1(s1)
    1056:	16090863          	beqz	s2,11c6 <vprintf+0x1b8>
    if(state == 0){
    105a:	fe0999e3          	bnez	s3,104c <vprintf+0x3e>
      if(c == '%'){
    105e:	ff4910e3          	bne	s2,s4,103e <vprintf+0x30>
        state = '%';
    1062:	89d2                	mv	s3,s4
    1064:	b7f5                	j	1050 <vprintf+0x42>
      if(c == 'd'){
    1066:	13490563          	beq	s2,s4,1190 <vprintf+0x182>
    106a:	f9d9079b          	addiw	a5,s2,-99
    106e:	0ff7f793          	zext.b	a5,a5
    1072:	12fb6863          	bltu	s6,a5,11a2 <vprintf+0x194>
    1076:	f9d9079b          	addiw	a5,s2,-99
    107a:	0ff7f713          	zext.b	a4,a5
    107e:	12eb6263          	bltu	s6,a4,11a2 <vprintf+0x194>
    1082:	00271793          	slli	a5,a4,0x2
    1086:	00000717          	auipc	a4,0x0
    108a:	6fa70713          	addi	a4,a4,1786 # 1780 <ithread_join+0x1b8>
    ...
    10a8:	ec2080e7          	jalr	-318(ra) # f66 <printint>
    10ac:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    10ae:	4981                	li	s3,0
    10b0:	b745                	j	1050 <vprintf+0x42>
        printint(fd, va_arg(ap, uint64), 10, 0);
    10b2:	008b8913          	addi	s2,s7,8
    10b6:	4681                	li	a3,0
    10b8:	4629                	li	a2,10
    10ba:	000ba583          	lw	a1,0(s7)
    10be:	8556                	mv	a0,s5
    10c0:	00000097          	auipc	ra,0x0
    10c4:	ea6080e7          	jalr	-346(ra) # f66 <printint>
    10c8:	8bca                	mv	s7,s2
      state = 0;
    10ca:	4981                	li	s3,0
    10cc:	b751                	j	1050 <vprintf+0x42>
    ...
    10e4:	8bca                	mv	s7,s2
      state = 0;
    10e6:	4981                	li	s3,0
    10e8:	b7a5                	j	1050 <vprintf+0x42>
    10ea:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    10ec:	008b8793          	addi	a5,s7,8
    10f0:	8c3e                	mv	s8,a5
    10f2:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    10f6:	03000593          	li	a1,48
    10fa:	8556                	mv	a0,s5
    10fc:	00000097          	auipc	ra,0x0
    1100:	e48080e7          	jalr	-440(ra) # f44 <putc>
  putc(fd, 'x');
    1104:	07800593          	li	a1,120
    1108:	8556                	mv	a0,s5
    110a:	00000097          	auipc	ra,0x0
    110e:	e3a080e7          	jalr	-454(ra) # f44 <putc>
    1112:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    1114:	00000b97          	auipc	s7,0x0
    1118:	6c4b8b93          	addi	s7,s7,1732 # 17d8 <digits>
    111c:	03c9d793          	srli	a5,s3,0x3c
    1120:	97de                	add	a5,a5,s7
    1122:	0007c583          	lbu	a1,0(a5)
    1126:	8556                	mv	a0,s5
    1128:	00000097          	auipc	ra,0x0
    112c:	e1c080e7          	jalr	-484(ra) # f44 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1130:	0992                	slli	s3,s3,0x4
    1132:	397d                	addiw	s2,s2,-1
    1134:	fe0914e3          	bnez	s2,111c <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
    1138:	8be2                	mv	s7,s8
      state = 0;
    113a:	4981                	li	s3,0
    113c:	6c02                	ld	s8,0(sp)
    113e:	bf09                	j	1050 <vprintf+0x42>
        s = va_arg(ap, char*);
    1140:	008b8993          	addi	s3,s7,8
    1144:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    1148:	02090163          	beqz	s2,116a <vprintf+0x15c>
        while(*s != 0){
    114c:	00094583          	lbu	a1,0(s2)
    1150:	c9a5                	beqz	a1,11c0 <vprintf+0x1b2>
          putc(fd, *s);
    1152:	8556                	mv	a0,s5
    1154:	00000097          	auipc	ra,0x0
    1158:	df0080e7          	jalr	-528(ra) # f44 <putc>
          s++;
    115c:	0905                	addi	s2,s2,1
        while(*s != 0){
    115e:	00094583          	lbu	a1,0(s2)
    1162:	f9e5                	bnez	a1,1152 <vprintf+0x144>
        s = va_arg(ap, char*);
    1164:	8bce                	mv	s7,s3
      state = 0;
    1166:	4981                	li	s3,0
    1168:	b5e5                	j	1050 <vprintf+0x42>
          s = "(null)";
    116a:	00000917          	auipc	s2,0x0
    116e:	5ae90913          	addi	s2,s2,1454 # 1718 <ithread_join+0x150>
        while(*s != 0){
    1172:	02800593          	li	a1,40
    1176:	bff1                	j	1152 <vprintf+0x144>
        putc(fd, va_arg(ap, uint));
    1178:	008b8913          	addi	s2,s7,8
    117c:	000bc583          	lbu	a1,0(s7)
    1180:	8556                	mv	a0,s5
    1182:	00000097          	auipc	ra,0x0
    1186:	dc2080e7          	jalr	-574(ra) # f44 <putc>
    118a:	8bca                	mv	s7,s2
      state = 0;
    118c:	4981                	li	s3,0
    118e:	b5c9                	j	1050 <vprintf+0x42>
        putc(fd, c);
    1190:	02500593          	li	a1,37
    1194:	8556                	mv	a0,s5
    1196:	00000097          	auipc	ra,0x0
    119a:	dae080e7          	jalr	-594(ra) # f44 <putc>
      state = 0;
    119e:	4981                	li	s3,0
    11a0:	bd45                	j	1050 <vprintf+0x42>
        putc(fd, '%');
    11a2:	02500593          	li	a1,37
    11a6:	8556                	mv	a0,s5
    11a8:	00000097          	auipc	ra,0x0
    11ac:	d9c080e7          	jalr	-612(ra) # f44 <putc>
        putc(fd, c);
    11b0:	85ca                	mv	a1,s2
    11b2:	8556                	mv	a0,s5
    11b4:	00000097          	auipc	ra,0x0
    11b8:	d90080e7          	jalr	-624(ra) # f44 <putc>
      state = 0;
    11bc:	4981                	li	s3,0
    11be:	bd49                	j	1050 <vprintf+0x42>
        s = va_arg(ap, char*);
    11c0:	8bce                	mv	s7,s3
      state = 0;
    11c2:	4981                	li	s3,0
    11c4:	b571                	j	1050 <vprintf+0x42>
    11c6:	74e2                	ld	s1,56(sp)
    11c8:	79a2                	ld	s3,40(sp)
    11ca:	7a02                	ld	s4,32(sp)
    11cc:	6ae2                	ld	s5,24(sp)
    11ce:	6b42                	ld	s6,16(sp)
    11d0:	6ba2                	ld	s7,8(sp)
    }
  }
}
    11d2:	60a6                	ld	ra,72(sp)
    11d4:	6406                	ld	s0,64(sp)
    11d6:	7942                	ld	s2,48(sp)
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    11fe:	e14080e7          	jalr	-492(ra) # 100e <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    1234:	dde080e7          	jalr	-546(ra) # 100e <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1250:	6e47b783          	ld	a5,1764(a5) # 2930 <freep>
    1254:	a039                	j	1262 <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1256:	6398                	ld	a4,0(a5)
    1258:	00e7e463          	bltu	a5,a4,1260 <free+0x20>
    125c:	00e6ea63          	bltu	a3,a4,1270 <free+0x30>
{
    1260:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1262:	fed7fae3          	bgeu	a5,a3,1256 <free+0x16>
    1266:	6398                	ld	a4,0(a5)
    1268:	00e6e463          	bltu	a3,a4,1270 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    126c:	fee7eae3          	bltu	a5,a4,1260 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    1270:	ff852583          	lw	a1,-8(a0)
    1274:	6390                	ld	a2,0(a5)
    1276:	02059813          	slli	a6,a1,0x20
    127a:	01c85713          	srli	a4,a6,0x1c
    127e:	9736                	add	a4,a4,a3
    1280:	02e60563          	beq	a2,a4,12aa <free+0x6a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    1284:	fec53823          	sd	a2,-16(a0)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    1288:	4790                	lw	a2,8(a5)
    128a:	02061593          	slli	a1,a2,0x20
    128e:	01c5d713          	srli	a4,a1,0x1c
    1292:	973e                	add	a4,a4,a5
    1294:	02e68263          	beq	a3,a4,12b8 <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    1298:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    129a:	00001717          	auipc	a4,0x1
    129e:	68f73b23          	sd	a5,1686(a4) # 2930 <freep>
}
...
malloc(uint nbytes)
{
    ...
    12d0:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    12d2:	02051993          	slli	s3,a0,0x20
    12d6:	0209d993          	srli	s3,s3,0x20
    12da:	09bd                	addi	s3,s3,15
    12dc:	0049d993          	srli	s3,s3,0x4
    12e0:	2985                	addiw	s3,s3,1
    12e2:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    12e4:	00001517          	auipc	a0,0x1
    12e8:	64c53503          	ld	a0,1612(a0) # 2930 <freep>
    12ec:	c905                	beqz	a0,131c <malloc+0x56>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    12f2:	09377a63          	bgeu	a4,s3,1386 <malloc+0xc0>
    12f6:	f426                	sd	s1,40(sp)
    12f8:	e852                	sd	s4,16(sp)
    12fa:	e456                	sd	s5,8(sp)
    12fc:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    12fe:	8a4e                	mv	s4,s3
    1300:	6705                	lui	a4,0x1
    1302:	00e9f363          	bgeu	s3,a4,1308 <malloc+0x42>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1310:	00001497          	auipc	s1,0x1
    1314:	62048493          	addi	s1,s1,1568 # 2930 <freep>
  if(p == (char*)-1)
    1318:	5afd                	li	s5,-1
    131a:	a089                	j	135c <malloc+0x96>
    131c:	f426                	sd	s1,40(sp)
    131e:	e852                	sd	s4,16(sp)
    1320:	e456                	sd	s5,8(sp)
    1322:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    1324:	00001797          	auipc	a5,0x1
    1328:	69478793          	addi	a5,a5,1684 # 29b8 <base>
    132c:	00001717          	auipc	a4,0x1
    1330:	60f73223          	sd	a5,1540(a4) # 2930 <freep>
    1334:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    1336:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    133a:	b7d1                	j	12fe <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    133c:	6398                	ld	a4,0(a5)
    133e:	e118                	sd	a4,0(a0)
    1340:	a8b9                	j	139e <malloc+0xd8>
  hp->s.size = nu;
    1342:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1346:	0541                	addi	a0,a0,16
    1348:	00000097          	auipc	ra,0x0
    134c:	ef8080e7          	jalr	-264(ra) # 1240 <free>
  return freep;
    1350:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    1352:	c135                	beqz	a0,13b6 <malloc+0xf0>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1354:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1356:	4798                	lw	a4,8(a5)
    1358:	03277363          	bgeu	a4,s2,137e <malloc+0xb8>
    if(p == freep)
    135c:	6098                	ld	a4,0(s1)
    135e:	853e                	mv	a0,a5
    1360:	fef71ae3          	bne	a4,a5,1354 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    1364:	8552                	mv	a0,s4
    1366:	00000097          	auipc	ra,0x0
    136a:	b58080e7          	jalr	-1192(ra) # ebe <sbrk>
  if(p == (char*)-1)
    136e:	fd551ae3          	bne	a0,s5,1342 <malloc+0x7c>
        return 0;
    1372:	4501                	li	a0,0
    ...
    137c:	a03d                	j	13aa <malloc+0xe4>
    137e:	74a2                	ld	s1,40(sp)
    1380:	6a42                	ld	s4,16(sp)
    1382:	6aa2                	ld	s5,8(sp)
    1384:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    1386:	fae90be3          	beq	s2,a4,133c <malloc+0x76>
        p->s.size -= nunits;
    138a:	4137073b          	subw	a4,a4,s3
    138e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1390:	02071693          	slli	a3,a4,0x20
    1394:	01c6d713          	srli	a4,a3,0x1c
    1398:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    139a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    139e:	00001717          	auipc	a4,0x1
    13a2:	58a73923          	sd	a0,1426(a4) # 2930 <freep>
      return (void*)(p + 1);
    13a6:	01078513          	addi	a0,a5,16
  }
}
    13aa:	70e2                	ld	ra,56(sp)
    13ac:	7442                	ld	s0,48(sp)
    13ae:	7902                	ld	s2,32(sp)
    13b0:	69e2                	ld	s3,24(sp)
    13b2:	6121                	addi	sp,sp,64
    13b4:	8082                	ret
    13b6:	74a2                	ld	s1,40(sp)
    13b8:	6a42                	ld	s4,16(sp)
    13ba:	6aa2                	ld	s5,8(sp)
    13bc:	6b02                	ld	s6,0(sp)
    13be:	b7f5                	j	13aa <malloc+0xe4>

00000000000013c0 <ithread_exit>:
  free(stacks);
  stacks = new_stacks;
  return 0;
}
...
void ithread_exit(uint64 status) {
    ...
    13c6:	0800                	addi	s0,sp,16
  thread_exit(status);
    13c8:	2501                	sext.w	a0,a0
    13ca:	00000097          	auipc	ra,0x0
    13ce:	b24080e7          	jalr	-1244(ra) # eee <thread_exit>
}
    13d2:	60a2                	ld	ra,8(sp)
    13d4:	6402                	ld	s0,0(sp)
    13d6:	0141                	addi	sp,sp,16
    13d8:	8082                	ret

00000000000013da <free_stacks>:
int free_stacks() {
    13da:	7179                	addi	sp,sp,-48
    13dc:	f406                	sd	ra,40(sp)
    13de:	f022                	sd	s0,32(sp)
    13e0:	ec26                	sd	s1,24(sp)
    13e2:	1800                	addi	s0,sp,48
  for (int i = 0; i < num_threads; i++) {
    13e4:	00001797          	auipc	a5,0x1
    13e8:	55c7a783          	lw	a5,1372(a5) # 2940 <num_threads>
    13ec:	04f05063          	blez	a5,142c <free_stacks+0x52>
    13f0:	e84a                	sd	s2,16(sp)
    13f2:	e44e                	sd	s3,8(sp)
    13f4:	4481                	li	s1,0
    free(stacks[i]);
    13f6:	00001997          	auipc	s3,0x1
    13fa:	54298993          	addi	s3,s3,1346 # 2938 <stacks>
  for (int i = 0; i < num_threads; i++) {
    13fe:	00001917          	auipc	s2,0x1
    1402:	54290913          	addi	s2,s2,1346 # 2940 <num_threads>
    free(stacks[i]);
    1406:	0009b783          	ld	a5,0(s3)
    140a:	00349713          	slli	a4,s1,0x3
    140e:	97ba                	add	a5,a5,a4
    1410:	6388                	ld	a0,0(a5)
    1412:	00000097          	auipc	ra,0x0
    1416:	e2e080e7          	jalr	-466(ra) # 1240 <free>
  for (int i = 0; i < num_threads; i++) {
    141a:	0485                	addi	s1,s1,1
    141c:	00092703          	lw	a4,0(s2)
    1420:	0004879b          	sext.w	a5,s1
    1424:	fee7c1e3          	blt	a5,a4,1406 <free_stacks+0x2c>
    1428:	6942                	ld	s2,16(sp)
    142a:	69a2                	ld	s3,8(sp)
  free(stacks);
    142c:	00001497          	auipc	s1,0x1
    1430:	50c48493          	addi	s1,s1,1292 # 2938 <stacks>
    1434:	6088                	ld	a0,0(s1)
    1436:	00000097          	auipc	ra,0x0
    143a:	e0a080e7          	jalr	-502(ra) # 1240 <free>
  stacks = 0;
    143e:	0004b023          	sd	zero,0(s1)
  num_threads = 0;
    1442:	00001797          	auipc	a5,0x1
    1446:	4e07af23          	sw	zero,1278(a5) # 2940 <num_threads>
  max_stacks = INIT_MAX_STACKS;
    144a:	47a1                	li	a5,8
    144c:	00001717          	auipc	a4,0x1
    1450:	4cf72a23          	sw	a5,1236(a4) # 2920 <max_stacks>
  threads_done = 0;
    1454:	00001797          	auipc	a5,0x1
    1458:	4e07a823          	sw	zero,1264(a5) # 2944 <threads_done>
}
    145c:	4501                	li	a0,0
    145e:	70a2                	ld	ra,40(sp)
    1460:	7402                	ld	s0,32(sp)
    1462:	64e2                	ld	s1,24(sp)
    1464:	6145                	addi	sp,sp,48
    1466:	8082                	ret

0000000000001468 <expand_num_threads>:
int expand_num_threads() {
    1468:	1101                	addi	sp,sp,-32
    146a:	ec06                	sd	ra,24(sp)
    146c:	e822                	sd	s0,16(sp)
    146e:	e426                	sd	s1,8(sp)
    1470:	e04a                	sd	s2,0(sp)
    1472:	1000                	addi	s0,sp,32
  max_stacks *= 2;
    1474:	00001797          	auipc	a5,0x1
    1478:	4ac78793          	addi	a5,a5,1196 # 2920 <max_stacks>
    147c:	4388                	lw	a0,0(a5)
    147e:	0015151b          	slliw	a0,a0,0x1
    1482:	c388                	sw	a0,0(a5)
  void **new_stacks = malloc(max_stacks*sizeof(char*));
    1484:	0035151b          	slliw	a0,a0,0x3
    1488:	00000097          	auipc	ra,0x0
    148c:	e3e080e7          	jalr	-450(ra) # 12c6 <malloc>
    1490:	892a                	mv	s2,a0
  memmove(new_stacks, stacks, num_threads*sizeof(char*));
    1492:	00001617          	auipc	a2,0x1
    1496:	4ae62603          	lw	a2,1198(a2) # 2940 <num_threads>
    149a:	00001497          	auipc	s1,0x1
    149e:	49e48493          	addi	s1,s1,1182 # 2938 <stacks>
    14a2:	0036161b          	slliw	a2,a2,0x3
    14a6:	608c                	ld	a1,0(s1)
    14a8:	00000097          	auipc	ra,0x0
    14ac:	8d8080e7          	jalr	-1832(ra) # d80 <memmove>
  free(stacks);
    14b0:	6088                	ld	a0,0(s1)
    14b2:	00000097          	auipc	ra,0x0
    14b6:	d8e080e7          	jalr	-626(ra) # 1240 <free>
  stacks = new_stacks;
    14ba:	0124b023          	sd	s2,0(s1)
}
    14be:	4501                	li	a0,0
    14c0:	60e2                	ld	ra,24(sp)
    14c2:	6442                	ld	s0,16(sp)
    14c4:	64a2                	ld	s1,8(sp)
    14c6:	6902                	ld	s2,0(sp)
    14c8:	6105                	addi	sp,sp,32
    14ca:	8082                	ret

00000000000014cc <ithread_create>:

int ithread_create(void* (*fn_ptr)(void *), void *args) {
    14cc:	7179                	addi	sp,sp,-48
    14ce:	f406                	sd	ra,40(sp)
    14d0:	f022                	sd	s0,32(sp)
    14d2:	e84a                	sd	s2,16(sp)
    14d4:	e44e                	sd	s3,8(sp)
    14d6:	1800                	addi	s0,sp,48
    14d8:	892a                	mv	s2,a0
    14da:	89ae                	mv	s3,a1
  if (stacks == 0) {
    14dc:	00001797          	auipc	a5,0x1
    14e0:	45c7b783          	ld	a5,1116(a5) # 2938 <stacks>
    14e4:	c3d9                	beqz	a5,156a <ithread_create+0x9e>
    stacks = malloc(max_stacks*sizeof(char*));
  }
  if (num_threads == max_stacks) {
    14e6:	00001797          	auipc	a5,0x1
    14ea:	43a7a783          	lw	a5,1082(a5) # 2920 <max_stacks>
    14ee:	00001717          	auipc	a4,0x1
    14f2:	45272703          	lw	a4,1106(a4) # 2940 <num_threads>
    14f6:	0af71463          	bne	a4,a5,159e <ithread_create+0xd2>
    if (max_stacks == MAX_THREADS) {
    14fa:	04000713          	li	a4,64
    14fe:	08e78563          	beq	a5,a4,1588 <ithread_create+0xbc>
    ...
    1508:	f64080e7          	jalr	-156(ra) # 1468 <expand_num_threads>
  }

  void *stack_ptr = malloc(PGSIZE);
    150c:	6505                	lui	a0,0x1
    150e:	00000097          	auipc	ra,0x0
    1512:	db8080e7          	jalr	-584(ra) # 12c6 <malloc>
    1516:	84aa                	mv	s1,a0
  stacks[num_threads] = stack_ptr;
    1518:	00001717          	auipc	a4,0x1
    151c:	42872703          	lw	a4,1064(a4) # 2940 <num_threads>
    1520:	070e                	slli	a4,a4,0x3
    1522:	00001797          	auipc	a5,0x1
    1526:	4167b783          	ld	a5,1046(a5) # 2938 <stacks>
    152a:	97ba                	add	a5,a5,a4
    152c:	e388                	sd	a0,0(a5)
  int res = create_thread(fn_ptr, args, stack_ptr, &ithread_exit);
    152e:	00000697          	auipc	a3,0x0
    1532:	e9268693          	addi	a3,a3,-366 # 13c0 <ithread_exit>
    1536:	862a                	mv	a2,a0
    1538:	85ce                	mv	a1,s3
    153a:	854a                	mv	a0,s2
    153c:	00000097          	auipc	ra,0x0
    1540:	9a2080e7          	jalr	-1630(ra) # ede <create_thread>
    1544:	892a                	mv	s2,a0
  if (res != -1) {
    1546:	57fd                	li	a5,-1
    1548:	04f50d63          	beq	a0,a5,15a2 <ithread_create+0xd6>
    num_threads++;
    154c:	00001717          	auipc	a4,0x1
    1550:	3f470713          	addi	a4,a4,1012 # 2940 <num_threads>
    1554:	431c                	lw	a5,0(a4)
    1556:	2785                	addiw	a5,a5,1
    1558:	c31c                	sw	a5,0(a4)
    155a:	64e2                	ld	s1,24(sp)
  } else {
    free(stack_ptr);
  ...
  return res;
    ...
    1566:	6145                	addi	sp,sp,48
    1568:	8082                	ret
    stacks = malloc(max_stacks*sizeof(char*));
    156a:	00001517          	auipc	a0,0x1
    156e:	3b652503          	lw	a0,950(a0) # 2920 <max_stacks>
    1572:	0035151b          	slliw	a0,a0,0x3
    1576:	00000097          	auipc	ra,0x0
    157a:	d50080e7          	jalr	-688(ra) # 12c6 <malloc>
    157e:	00001797          	auipc	a5,0x1
    1582:	3aa7bd23          	sd	a0,954(a5) # 2938 <stacks>
    1586:	b785                	j	14e6 <ithread_create+0x1a>
      printf("ERROR: Thread capacity has been reached\n");
    1588:	00000517          	auipc	a0,0x0
    158c:	19850513          	addi	a0,a0,408 # 1720 <ithread_join+0x158>
    1590:	00000097          	auipc	ra,0x0
    1594:	c7a080e7          	jalr	-902(ra) # 120a <printf>
      return -1;
    1598:	57fd                	li	a5,-1
    159a:	893e                	mv	s2,a5
    159c:	b7c1                	j	155c <ithread_create+0x90>
    159e:	ec26                	sd	s1,24(sp)
    15a0:	b7b5                	j	150c <ithread_create+0x40>
    free(stack_ptr);
    15a2:	8526                	mv	a0,s1
    15a4:	00000097          	auipc	ra,0x0
    15a8:	c9c080e7          	jalr	-868(ra) # 1240 <free>
    stacks[num_threads] = 0;
    15ac:	00001717          	auipc	a4,0x1
    15b0:	39472703          	lw	a4,916(a4) # 2940 <num_threads>
    15b4:	070e                	slli	a4,a4,0x3
    15b6:	00001797          	auipc	a5,0x1
    15ba:	3827b783          	ld	a5,898(a5) # 2938 <stacks>
    15be:	97ba                	add	a5,a5,a4
    15c0:	0007b023          	sd	zero,0(a5)
    15c4:	64e2                	ld	s1,24(sp)
    15c6:	bf59                	j	155c <ithread_create+0x90>

00000000000015c8 <ithread_join>:

int ithread_join(int thread_id) {
    15c8:	1101                	addi	sp,sp,-32
    15ca:	ec06                	sd	ra,24(sp)
    15cc:	e822                	sd	s0,16(sp)
    15ce:	1000                	addi	s0,sp,32
  int status;
  join_thread(thread_id, (uint64)&status);
    15d0:	ff040793          	addi	a5,s0,-16
    15d4:	ffc7859b          	addiw	a1,a5,-4
    15d8:	00000097          	auipc	ra,0x0
    15dc:	90e080e7          	jalr	-1778(ra) # ee6 <join_thread>
  threads_done++;
    15e0:	00001717          	auipc	a4,0x1
    15e4:	36470713          	addi	a4,a4,868 # 2944 <threads_done>
    15e8:	431c                	lw	a5,0(a4)
    15ea:	2785                	addiw	a5,a5,1
    15ec:	c31c                	sw	a5,0(a4)
  if (threads_done == num_threads) {
    15ee:	00001717          	auipc	a4,0x1
    15f2:	35272703          	lw	a4,850(a4) # 2940 <num_threads>
    15f6:	00f70863          	beq	a4,a5,1606 <ithread_join+0x3e>
    free_stacks();
  }
  return status;
}
    15fa:	fec42503          	lw	a0,-20(s0)
    15fe:	60e2                	ld	ra,24(sp)
    1600:	6442                	ld	s0,16(sp)
    1602:	6105                	addi	sp,sp,32
    1604:	8082                	ret
    free_stacks();
    1606:	00000097          	auipc	ra,0x0
    160a:	dd4080e7          	jalr	-556(ra) # 13da <free_stacks>
    160e:	b7f5                	j	15fa <ithread_join+0x32>
