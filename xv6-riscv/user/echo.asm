...
main(int argc, char *argv[])
{
  ...
  2e:	a66a0a13          	addi	s4,s4,-1434 # a90 <ithread_join+0x50>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	a3058593          	addi	a1,a1,-1488 # a98 <ithread_join+0x58>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 412:	6f250513          	addi	a0,a0,1778 # b00 <digits>
 416:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d2:	5dac8c93          	addi	s9,s9,1498 # aa8 <ithread_join+0x68>
 ...
 4e0:	624b8b93          	addi	s7,s7,1572 # b00 <digits>
 ...
 606:	49e98993          	addi	s3,s3,1182 # aa0 <ithread_join+0x60>
        while(*s != 0){
 60a:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6e8:	92c7b783          	ld	a5,-1748(a5) # 1010 <freep>
 ...
 710:	00e6ea63          	bltu	a3,a4,724 <free+0x4a>
{
 ...
 752:	8cf73123          	sd	a5,-1854(a4) # 1010 <freep>
}
 756:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 784:	89053503          	ld	a0,-1904(a0) # 1010 <freep>
 ...
 7ac:	86890913          	addi	s2,s2,-1944 # 1010 <freep>
  if(p == (char*)-1)
 7b0:	5afd                	li	s5,-1
 7b2:	a895                	j	826 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7b4:	00001797          	auipc	a5,0x1
 7b8:	87c78793          	addi	a5,a5,-1924 # 1030 <base>
 7bc:	00001717          	auipc	a4,0x1
 7c0:	84f73a23          	sd	a5,-1964(a4) # 1010 <freep>
 7c4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e8:	82a73623          	sd	a0,-2004(a4) # 1010 <freep>
      return (void*)(p + 1);
...
void ithread_exit(uint64 status) {
 ...
 84e:	b78080e7          	jalr	-1160(ra) # 3c2 <thread_exit>
}
 852:	60a2                	ld	ra,8(sp)
 854:	6402                	ld	s0,0(sp)
...
int free_stacks() {
 ...
 86c:	7b87a783          	lw	a5,1976(a5) # 1020 <num_threads>
 870:	02f05c63          	blez	a5,8a8 <free_stacks+0x4e>
 874:	4481                	li	s1,0
    free(stacks[i]);
 876:	00000997          	auipc	s3,0x0
 87a:	7a298993          	addi	s3,s3,1954 # 1018 <stacks>
  for (int i = 0; i < num_threads; i++) {
 87e:	00000917          	auipc	s2,0x0
 882:	7a290913          	addi	s2,s2,1954 # 1020 <num_threads>
    free(stacks[i]);
 886:	0009b783          	ld	a5,0(s3)
 88a:	00349713          	slli	a4,s1,0x3
 88e:	97ba                	add	a5,a5,a4
 890:	6388                	ld	a0,0(a5)
 892:	00000097          	auipc	ra,0x0
 896:	e48080e7          	jalr	-440(ra) # 6da <free>
  for (int i = 0; i < num_threads; i++) {
 89a:	0485                	addi	s1,s1,1
 89c:	00092703          	lw	a4,0(s2)
 8a0:	0004879b          	sext.w	a5,s1
 8a4:	fee7c1e3          	blt	a5,a4,886 <free_stacks+0x2c>
  free(stacks);
 8a8:	00000497          	auipc	s1,0x0
 8ac:	77048493          	addi	s1,s1,1904 # 1018 <stacks>
 8b0:	6088                	ld	a0,0(s1)
 8b2:	00000097          	auipc	ra,0x0
 8b6:	e28080e7          	jalr	-472(ra) # 6da <free>
  stacks = 0;
 8ba:	0004b023          	sd	zero,0(s1)
  num_threads = 0;
 8be:	00000797          	auipc	a5,0x0
 8c2:	7607a123          	sw	zero,1890(a5) # 1020 <num_threads>
  max_stacks = INIT_MAX_STACKS;
 8c6:	47a1                	li	a5,8
 8c8:	00000717          	auipc	a4,0x0
 8cc:	72f72c23          	sw	a5,1848(a4) # 1000 <max_stacks>
  threads_done = 0;
 8d0:	00000797          	auipc	a5,0x0
 8d4:	7407aa23          	sw	zero,1876(a5) # 1024 <threads_done>
}
 8d8:	4501                	li	a0,0
...
00000000000008e8 <expand_num_threads>:
int expand_num_threads() {
 ...
 8f8:	70c78793          	addi	a5,a5,1804 # 1000 <max_stacks>
 8fc:	4388                	lw	a0,0(a5)
 8fe:	0015151b          	slliw	a0,a0,0x1
 902:	c388                	sw	a0,0(a5)
  void **new_stacks = malloc(max_stacks*sizeof(char*));
 904:	0035151b          	slliw	a0,a0,0x3
 908:	00000097          	auipc	ra,0x0
 90c:	e54080e7          	jalr	-428(ra) # 75c <malloc>
 910:	892a                	mv	s2,a0
  memmove(new_stacks, stacks, num_threads*sizeof(char*));
 912:	00000617          	auipc	a2,0x0
 916:	70e62603          	lw	a2,1806(a2) # 1020 <num_threads>
 91a:	00000497          	auipc	s1,0x0
 91e:	6fe48493          	addi	s1,s1,1790 # 1018 <stacks>
 922:	0036161b          	slliw	a2,a2,0x3
 926:	608c                	ld	a1,0(s1)
 928:	00000097          	auipc	ra,0x0
 92c:	930080e7          	jalr	-1744(ra) # 258 <memmove>
  free(stacks);
 930:	6088                	ld	a0,0(s1)
 932:	00000097          	auipc	ra,0x0
 936:	da8080e7          	jalr	-600(ra) # 6da <free>
  stacks = new_stacks;
 93a:	0124b023          	sd	s2,0(s1)
}
 93e:	4501                	li	a0,0
...
000000000000094c <ithread_create>:

int ithread_create(void* (*fn_ptr)(void *), void *args) {
 94c:	7179                	addi	sp,sp,-48
 94e:	f406                	sd	ra,40(sp)
 950:	f022                	sd	s0,32(sp)
 952:	ec26                	sd	s1,24(sp)
 954:	e84a                	sd	s2,16(sp)
 956:	e44e                	sd	s3,8(sp)
 ...
 962:	6ba7b783          	ld	a5,1722(a5) # 1018 <stacks>
 966:	c3d1                	beqz	a5,9ea <ithread_create+0x9e>
    stacks = malloc(max_stacks*sizeof(char*));
  }
  if (num_threads == max_stacks) {
 968:	00000797          	auipc	a5,0x0
 96c:	6987a783          	lw	a5,1688(a5) # 1000 <max_stacks>
 970:	00000717          	auipc	a4,0x0
 974:	6b072703          	lw	a4,1712(a4) # 1020 <num_threads>
 978:	00f71a63          	bne	a4,a5,98c <ithread_create+0x40>
    if (max_stacks == MAX_THREADS) {
 97c:	04000713          	li	a4,64
 980:	08e78463          	beq	a5,a4,a08 <ithread_create+0xbc>
      printf("ERROR: Thread capacity has been reached\n");
      return -1;
    }
    expand_num_threads();
 984:	00000097          	auipc	ra,0x0
 988:	f64080e7          	jalr	-156(ra) # 8e8 <expand_num_threads>
  }

  void *stack_ptr = malloc(PGSIZE);
 98c:	6505                	lui	a0,0x1
 98e:	00000097          	auipc	ra,0x0
 992:	dce080e7          	jalr	-562(ra) # 75c <malloc>
 996:	84aa                	mv	s1,a0
  stacks[num_threads] = stack_ptr;
 998:	00000717          	auipc	a4,0x0
 99c:	68872703          	lw	a4,1672(a4) # 1020 <num_threads>
 9a0:	070e                	slli	a4,a4,0x3
 9a2:	00000797          	auipc	a5,0x0
 9a6:	6767b783          	ld	a5,1654(a5) # 1018 <stacks>
 9aa:	97ba                	add	a5,a5,a4
 9ac:	e388                	sd	a0,0(a5)
  int res = create_thread(fn_ptr, args, stack_ptr, &ithread_exit);
 9ae:	00000697          	auipc	a3,0x0
 9b2:	e9468693          	addi	a3,a3,-364 # 842 <ithread_exit>
 9b6:	862a                	mv	a2,a0
 9b8:	85ce                	mv	a1,s3
 9ba:	854a                	mv	a0,s2
 9bc:	00000097          	auipc	ra,0x0
 9c0:	9f6080e7          	jalr	-1546(ra) # 3b2 <create_thread>
 9c4:	892a                	mv	s2,a0
  if (res != -1) {
 9c6:	57fd                	li	a5,-1
 9c8:	04f50a63          	beq	a0,a5,a1c <ithread_create+0xd0>
    num_threads++;
 9cc:	00000717          	auipc	a4,0x0
 9d0:	65470713          	addi	a4,a4,1620 # 1020 <num_threads>
 9d4:	431c                	lw	a5,0(a4)
 ...
 9e0:	64e2                	ld	s1,24(sp)
 9e2:	6942                	ld	s2,16(sp)
 9e4:	69a2                	ld	s3,8(sp)
 9e6:	6145                	addi	sp,sp,48
 9e8:	8082                	ret
    stacks = malloc(max_stacks*sizeof(char*));
 9ea:	00000517          	auipc	a0,0x0
 9ee:	61652503          	lw	a0,1558(a0) # 1000 <max_stacks>
 9f2:	0035151b          	slliw	a0,a0,0x3
 9f6:	00000097          	auipc	ra,0x0
 9fa:	d66080e7          	jalr	-666(ra) # 75c <malloc>
 9fe:	00000797          	auipc	a5,0x0
 a02:	60a7bd23          	sd	a0,1562(a5) # 1018 <stacks>
 a06:	b78d                	j	968 <ithread_create+0x1c>
      printf("ERROR: Thread capacity has been reached\n");
 a08:	00000517          	auipc	a0,0x0
 a0c:	11050513          	addi	a0,a0,272 # b18 <digits+0x18>
 a10:	00000097          	auipc	ra,0x0
 a14:	c94080e7          	jalr	-876(ra) # 6a4 <printf>
      return -1;
 a18:	597d                	li	s2,-1
 a1a:	b7c1                	j	9da <ithread_create+0x8e>
    free(stack_ptr);
 a1c:	8526                	mv	a0,s1
 a1e:	00000097          	auipc	ra,0x0
 a22:	cbc080e7          	jalr	-836(ra) # 6da <free>
    stacks[num_threads] = 0;
 a26:	00000717          	auipc	a4,0x0
 a2a:	5fa72703          	lw	a4,1530(a4) # 1020 <num_threads>
 a2e:	070e                	slli	a4,a4,0x3
 a30:	00000797          	auipc	a5,0x0
 a34:	5e87b783          	ld	a5,1512(a5) # 1018 <stacks>
 a38:	97ba                	add	a5,a5,a4
 a3a:	0007b023          	sd	zero,0(a5)
 a3e:	bf71                	j	9da <ithread_create+0x8e>

0000000000000a40 <ithread_join>:

int ithread_join(int thread_id) {
 a40:	1101                	addi	sp,sp,-32
 a42:	ec06                	sd	ra,24(sp)
 a44:	e822                	sd	s0,16(sp)
 a46:	1000                	addi	s0,sp,32
  int status;
  join_thread(thread_id, (uint64)&status);
 a48:	fec40593          	addi	a1,s0,-20
 a4c:	00000097          	auipc	ra,0x0
 a50:	96e080e7          	jalr	-1682(ra) # 3ba <join_thread>
  threads_done++;
 a54:	00000717          	auipc	a4,0x0
 a58:	5d070713          	addi	a4,a4,1488 # 1024 <threads_done>
 a5c:	431c                	lw	a5,0(a4)
 a5e:	2785                	addiw	a5,a5,1
 a60:	0007869b          	sext.w	a3,a5
 a64:	c31c                	sw	a5,0(a4)
  if (threads_done == num_threads) {
 a66:	00000797          	auipc	a5,0x0
 a6a:	5ba7a783          	lw	a5,1466(a5) # 1020 <num_threads>
 a6e:	00d78863          	beq	a5,a3,a7e <ithread_join+0x3e>
    free_stacks();
  }
  return status;
}
 a72:	fec42503          	lw	a0,-20(s0)
 ...
 a82:	ddc080e7          	jalr	-548(ra) # 85a <free_stacks>
 a86:	b7f5                	j	a72 <ithread_join+0x32>
