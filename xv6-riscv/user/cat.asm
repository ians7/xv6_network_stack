...
cat(int fd)
{
  ...
  44:	af058593          	addi	a1,a1,-1296 # b30 <ithread_join+0x56>
  48:	4509                	li	a0,2
  ...
  72:	ada58593          	addi	a1,a1,-1318 # b48 <ithread_join+0x6e>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	a5e58593          	addi	a1,a1,-1442 # b60 <ithread_join+0x86>
 10a:	4509                	li	a0,2
...
000000000000044c <create_thread>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ac:	73050513          	addi	a0,a0,1840 # bd8 <digits>
 4b0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 56c:	618c8c93          	addi	s9,s9,1560 # b80 <ithread_join+0xa6>
 ...
 57a:	662b8b93          	addi	s7,s7,1634 # bd8 <digits>
 ...
 6a0:	4dc98993          	addi	s3,s3,1244 # b78 <ithread_join+0x9e>
        while(*s != 0){
 6a4:	85ee                	mv	a1,s11
 ...
 7aa:	00e6ea63          	bltu	a3,a4,7be <free+0x4a>
{
 ...
 7ec:	82f73423          	sd	a5,-2008(a4) # 1010 <freep>
}
 7f0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 81e:	7f653503          	ld	a0,2038(a0) # 1010 <freep>
 ...
 846:	7ce90913          	addi	s2,s2,1998 # 1010 <freep>
  if(p == (char*)-1)
 84a:	5afd                	li	s5,-1
 84c:	a895                	j	8c0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 84e:	00001797          	auipc	a5,0x1
 852:	9e278793          	addi	a5,a5,-1566 # 1230 <base>
...
void ithread_exit(uint64 status) {
 ...
 8e8:	b78080e7          	jalr	-1160(ra) # 45c <thread_exit>
}
 8ec:	60a2                	ld	ra,8(sp)
 8ee:	6402                	ld	s0,0(sp)
...
int free_stacks() {
 ...
 906:	71e7a783          	lw	a5,1822(a5) # 1020 <num_threads>
 90a:	02f05c63          	blez	a5,942 <free_stacks+0x4e>
 90e:	4481                	li	s1,0
    free(stacks[i]);
 910:	00000997          	auipc	s3,0x0
 914:	70898993          	addi	s3,s3,1800 # 1018 <stacks>
  for (int i = 0; i < num_threads; i++) {
 918:	00000917          	auipc	s2,0x0
 91c:	70890913          	addi	s2,s2,1800 # 1020 <num_threads>
    free(stacks[i]);
 ...
 930:	e48080e7          	jalr	-440(ra) # 774 <free>
  for (int i = 0; i < num_threads; i++) {
 ...
 946:	6d648493          	addi	s1,s1,1750 # 1018 <stacks>
 94a:	6088                	ld	a0,0(s1)
 94c:	00000097          	auipc	ra,0x0
 950:	e28080e7          	jalr	-472(ra) # 774 <free>
  stacks = 0;
 954:	0004b023          	sd	zero,0(s1)
  num_threads = 0;
 958:	00000797          	auipc	a5,0x0
 95c:	6c07a423          	sw	zero,1736(a5) # 1020 <num_threads>
  max_stacks = INIT_MAX_STACKS;
 960:	47a1                	li	a5,8
 962:	00000717          	auipc	a4,0x0
 966:	68f72f23          	sw	a5,1694(a4) # 1000 <max_stacks>
  threads_done = 0;
 96a:	00000797          	auipc	a5,0x0
 96e:	6a07ad23          	sw	zero,1722(a5) # 1024 <threads_done>
}
 972:	4501                	li	a0,0
...
int expand_num_threads() {
 ...
 992:	67278793          	addi	a5,a5,1650 # 1000 <max_stacks>
 996:	4388                	lw	a0,0(a5)
 ...
 9a6:	e54080e7          	jalr	-428(ra) # 7f6 <malloc>
 9aa:	892a                	mv	s2,a0
  memmove(new_stacks, stacks, num_threads*sizeof(char*));
 9ac:	00000617          	auipc	a2,0x0
 9b0:	67462603          	lw	a2,1652(a2) # 1020 <num_threads>
 9b4:	00000497          	auipc	s1,0x0
 9b8:	66448493          	addi	s1,s1,1636 # 1018 <stacks>
 9bc:	0036161b          	slliw	a2,a2,0x3
 9c0:	608c                	ld	a1,0(s1)
 9c2:	00000097          	auipc	ra,0x0
 9c6:	930080e7          	jalr	-1744(ra) # 2f2 <memmove>
  free(stacks);
 9ca:	6088                	ld	a0,0(s1)
 9cc:	00000097          	auipc	ra,0x0
 9d0:	da8080e7          	jalr	-600(ra) # 774 <free>
  stacks = new_stacks;
...
int ithread_create(void* (*fn_ptr)(void *), void *args) {
 ...
 9fc:	6207b783          	ld	a5,1568(a5) # 1018 <stacks>
 a00:	c3d1                	beqz	a5,a84 <ithread_create+0x9e>
    stacks = malloc(max_stacks*sizeof(char*));
  }
  if (num_threads == max_stacks) {
 a02:	00000797          	auipc	a5,0x0
 a06:	5fe7a783          	lw	a5,1534(a5) # 1000 <max_stacks>
 a0a:	00000717          	auipc	a4,0x0
 a0e:	61672703          	lw	a4,1558(a4) # 1020 <num_threads>
 a12:	00f71a63          	bne	a4,a5,a26 <ithread_create+0x40>
    if (max_stacks == MAX_THREADS) {
 a16:	04000713          	li	a4,64
 a1a:	08e78463          	beq	a5,a4,aa2 <ithread_create+0xbc>
 ...
 a2c:	dce080e7          	jalr	-562(ra) # 7f6 <malloc>
 a30:	84aa                	mv	s1,a0
  stacks[num_threads] = stack_ptr;
 a32:	00000717          	auipc	a4,0x0
 a36:	5ee72703          	lw	a4,1518(a4) # 1020 <num_threads>
 ...
 a5a:	9f6080e7          	jalr	-1546(ra) # 44c <create_thread>
 a5e:	892a                	mv	s2,a0
  if (res != -1) {
 a60:	57fd                	li	a5,-1
 a62:	04f50a63          	beq	a0,a5,ab6 <ithread_create+0xd0>
    num_threads++;
 a66:	00000717          	auipc	a4,0x0
 a6a:	5ba70713          	addi	a4,a4,1466 # 1020 <num_threads>
 a6e:	431c                	lw	a5,0(a4)
 ...
 a74:	854a                	mv	a0,s2
 a76:	70a2                	ld	ra,40(sp)
 a78:	7402                	ld	s0,32(sp)
 ...
 a88:	57c52503          	lw	a0,1404(a0) # 1000 <max_stacks>
 a8c:	0035151b          	slliw	a0,a0,0x3
 a90:	00000097          	auipc	ra,0x0
 a94:	d66080e7          	jalr	-666(ra) # 7f6 <malloc>
 a98:	00000797          	auipc	a5,0x0
 a9c:	58a7b023          	sd	a0,1408(a5) # 1018 <stacks>
 aa0:	b78d                	j	a02 <ithread_create+0x1c>
      printf("ERROR: Thread capacity has been reached\n");
 aa2:	00000517          	auipc	a0,0x0
 aa6:	14e50513          	addi	a0,a0,334 # bf0 <digits+0x18>
 aaa:	00000097          	auipc	ra,0x0
 aae:	c94080e7          	jalr	-876(ra) # 73e <printf>
      return -1;
 ab2:	597d                	li	s2,-1
 ab4:	b7c1                	j	a74 <ithread_create+0x8e>
    free(stack_ptr);
 ab6:	8526                	mv	a0,s1
 ab8:	00000097          	auipc	ra,0x0
 abc:	cbc080e7          	jalr	-836(ra) # 774 <free>
    stacks[num_threads] = 0;
 ac0:	00000717          	auipc	a4,0x0
 ac4:	56072703          	lw	a4,1376(a4) # 1020 <num_threads>
 ac8:	070e                	slli	a4,a4,0x3
 aca:	00000797          	auipc	a5,0x0
 ace:	54e7b783          	ld	a5,1358(a5) # 1018 <stacks>
 ad2:	97ba                	add	a5,a5,a4
 ad4:	0007b023          	sd	zero,0(a5)
 ad8:	bf71                	j	a74 <ithread_create+0x8e>

0000000000000ada <ithread_join>:
...
int ithread_join(int thread_id) {
 ...
 ae2:	fec40593          	addi	a1,s0,-20
 ae6:	00000097          	auipc	ra,0x0
 aea:	96e080e7          	jalr	-1682(ra) # 454 <join_thread>
  threads_done++;
 aee:	00000717          	auipc	a4,0x0
 af2:	53670713          	addi	a4,a4,1334 # 1024 <threads_done>
 af6:	431c                	lw	a5,0(a4)
 af8:	2785                	addiw	a5,a5,1
 afa:	0007869b          	sext.w	a3,a5
 afe:	c31c                	sw	a5,0(a4)
  if (threads_done == num_threads) {
 b00:	00000797          	auipc	a5,0x0
 b04:	5207a783          	lw	a5,1312(a5) # 1020 <num_threads>
 b08:	00d78863          	beq	a5,a3,b18 <ithread_join+0x3e>
    free_stacks();
  }
  return status;
}
 ...
 b1c:	ddc080e7          	jalr	-548(ra) # 8f4 <free_stacks>
 b20:	b7f5                	j	b0c <ithread_join+0x32>
